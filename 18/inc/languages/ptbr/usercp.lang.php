 ...
 *Traduzido por : "dthiago"  "bf4brasil.com.br"
 */

$l['nav_usercp'] = "Painel de Controle do Usuário";
$l['nav_profile'] = "Editar Perfil";
$l['nav_options'] = "Editar Opções";
$l['nav_email'] = "Modificar endereço de e-mail";
$l['nav_password'] = "Modificar senha";
$l['nav_changename'] = "Modificar nome de usuário";
...
$l['nav_editlists'] = "Gerenciar amigos e lista de ignorados";
$l['nav_drafts'] = "Salvar rascunhos";
$l['nav_usergroups'] = "Amizades";
...
$l['away_notice_away'] = "Você foi marcado desde {1}";
$l['away_notice'] = "Esta opção permite informar se está afastado ou não";
$l['already_uploaded_avatar'] = "Você está usando um avatar enviado por você. Se enviar outro o anterior será deletado.";
$l['na_deleted'] = "N/A - fora deletado";
$l['user_cp'] = "Painel de Controle de Usuário";
$l['user_cp_welcome'] = "Este é o seu painel de controle. Você pode acessar o seu perfil, subscrições e mensagens privadas tudo por aqui.<br />A página principal sobre a sua conta.";
$l['account_summary'] = "Resumo da conta";
$l['username'] = "Nome de usuário:";
$l['user_id'] = "ID do usuário:";
$l['title'] = "Título de Usuário:";
$l['postnum'] = "Postagens:";
$l['posts_day'] = "({1} por dia | {2} percentual total de postagens)";
...
$l['change_avatar'] = "Mudar avatar";
$l['avatar_url'] = "URL do avatar:";
$l['avatar_url_note'] = "Insira o link para uma imagem da internet";
$l['avatar_url_gravatar'] = "Para usar o  <a href=\"http://gravatar.com\" target=\"_blank\">Gravatar</a> insira o seu e-mail relativo ao gravatar.";
$l['avatar_upload'] = "Enviar avatar:";
$l['avatar_upload_note'] = "Escolher uma avatar do computador para envio.";
$l['no_avatar'] = "Sem Avatar";
$l['no_avatar_note'] = "Selecione esta opção se não quiser um avatar.";
$l['change_username'] = "Mudar nome de usuário";
$l['new_username'] = "Novo nome de usuário:";
$l['update_username'] = "Atualizar nome de usuário";
$l['edit_lists'] = "Editar amigos e lista de ignorados";
$l['edit_buddy_list'] = "Editar amigos";
$l['edit_ignore_list'] = "Edit ignorados";
$l['users_added_to_ignore_list'] = "O(s) selecionado(s) fora(m) adicionados à sua lista de ignorados";
$l['users_added_to_buddy_list'] = "A lista de usuário(s) adicionados à sua lista de amigos";
$l['removed_from_ignore_list'] = "{1} fora removido da lista de ignorados";
$l['removed_from_buddy_list'] = "{1} fora removido da sua lista de amigos";
...
$l['users_already_on_ignore_list'] = "Alguns destes usuários já foram adicionados à sua lista de ignorados";
$l['users_already_on_ignore_list_alt'] = "Alguns destes usuários já foram adicionados à sua lista de amigos. Por favor remova-os dos amigos antes de ignorá-los";
$l['users_already_on_buddy_list'] = "Alguns destes usuários já foram adicionados à sua lista de amigos.";
$l['users_already_on_buddy_list_alt'] = "Alguns destes usuários já foram adicionados à sua lista de ignorados. Por favor remova-os dos ignorados antes de adicionar como amigos.";
$l['invalid_user_selected'] = "Alguns usuários não foram encontrados";
$l['ignore_list_empty'] = "Sua lista de ignorados está vazio. Para adicionar um ou mais usuários para sua lista de ignorados, por favor use o campo acima.";
...
$l['adding_buddy'] = "Adicionando amigos.";
