...
$l['bad_word_filters_desc'] = "Este recurso permite que você gerencie uma lista de palavras ou frases que são automaticamente substituídas nas postagens de seu fórum. É útil para substituir palavras de baixo calão (palavrões) e outros.";

$l['bad_word'] = "Palavra";
$l['bad_word_desc'] = "Insira a palavra que você deseja filtrar. O '*' (asterisco) representa qualquer caractere simples (a-zA-Z0-9_).";
$l['bad_word_max'] = "Uma palavra filtrada não pode exceder 100 caracteres.";
$l['replacement'] = "Substituto";
$l['replacement_desc'] = "Digite a sequência que irá substituir a palavra filtrada (Se deixar em branco, asteriscos serão mostrados)";
$l['replacement_word_max'] = "Uma palavra substituída não pode exceder 100 caracteres.";
$l['error_replacement_word_invalid'] = "A palavra substituta não deve ser igual a filtrada.";
...
$l['confirm_bad_word_deletion'] = "Você tem certeza que deseja excluir este filtro?"; //Modificado para certeza, conforme original e padrão.
